...
const SystemStatusCards = ({ totalSurveys, pendingSyncCount, failedSyncs }: SystemStatusCardsProps) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Local Surveys</CardTitle>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-orange-600">{pendingSyncCount}</div>
        </CardContent>
      </Card>
